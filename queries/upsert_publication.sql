...
VALUES
  (:publication_id, UNHEX(:producer_id), :canonical_url, :title, :publication_text, :published_at, :first_seen_at, :last_updated_at, :urls, :hashtags, :keywords, :tags, :metadata, :comments, :version, :author, :connect_from)
